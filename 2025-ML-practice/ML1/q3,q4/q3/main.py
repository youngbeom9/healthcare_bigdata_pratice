...
def main():
    # 데이터를 불러옵니다.
    x_train, y_train, x_val, y_val = preprocess.load_data(r"C:\Users\302-28\git-repo\2025-ML-practice\q3,q4\q3\data\iris.csv", independent_var = ['petal length', 'sepal length'], response_var = 'class_num' )
